...
public class BannerVPAdapter3 extends PagerAdapter implements ViewPager.OnPageChangeListener{
    ...
    public BannerVPAdapter3(Context context, List<ImageView> imageViews, ViewPager vp) {
